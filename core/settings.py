...
CORS_ALLOW_ALL_ORIGINS = os.environ.get("CORS_ALLOW_ALL_ORIGINS ", default="http://localhost:5500").split(",")
...
AUTH_USER_MODEL = 'auth_app.Profiles'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'auth_app.auth.CookieJWTAuthentication',
